...
Cloud Manager Connector의 네트워킹 요구사항에 대한 자세한 내용은 를 참조하십시오 https://docs.netapp.com/us-en/cloud-manager-connector/reference-networking-cloud-manager.html["커넥터에 대한 네트워킹 요구 사항"^].
